...
export default {
  ...
  mounted() {
    ...
    cdstorage.setItem("nombre3000", "Jorge delgadillo");

    cdstorage.setItem("otra-variable", "");

    cdstorage.setItem(
      "variable_A_REACT",
      "Esto es una variable que viaja de VUE A REACT"
    );

    cdstorage.setItem(
      "otra_variebla_vue",
      "SIGUIENTE EJEMPLO DESDE VUE A REACT"
    );
